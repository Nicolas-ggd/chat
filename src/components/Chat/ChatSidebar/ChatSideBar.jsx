        ...
        <div className="h-full flex flex-col justify-between">
          <div>
            <div
              ...
              className="flex flex-row py-4 px-2 justify-center items-center border-b-2 hover:bg-gray-200 cursor-pointer transition duration-400"
            >
              <div className="w-1/4">
                <button className="bg-gray-300 p-2 h-12 w-12 rounded-3xl">
                  <AddIcon />
                </button>
              </div>
              <div className="w-full px-3">
                <span className="text-gray-500">Join a room</span>
              </div>
            </div>
